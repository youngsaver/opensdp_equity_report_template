...
data$race_ethnicity <- relevel(data$race_ethnicity, ref = "White")
...
# // Step 6. Plot
ggplot(chartData[chartData$term == "race_ethnicityHispanic or Latino Ethnicity", ],
       aes(x = model, y = -estimate, fill = model)) + 
        ...
        scale_y_continuous(limit = c(-3,2.5), name = "Scale Score") + 
