...
gender inequities are very different between socioeconomic levels. Since the gap
persists at each socioeconomic level, our analysis should focus on the gender 
gap overall, rather than for any one particular set of socioeconomic subgroups.
...
greatest magnitude gaps--such as school number 8 in our data-- has discriminatory 
