...
dem.male <- list( test1 = c(grade = 5, subject = "math_ss", group = c("Female","Male")),
                  test2 = c(grade = 8, subject = "math_ss", group = c("Female","Male")))
...
**Analytic Technique:** To get a sense of where students from our target student populations are performing the worst overall, we will calculate the median reading test scores at each campus among LEP students and median math test scores at each campus among female students. Again, we choose the medians here because they are less susceptible to skew and outliers.
...
#For each demographic marker
dem.male <- list( test1 = c(grade = 5, subject = "math_ss", group = "Female"),
                  test2 = c(grade = 8, subject = "math_ss", group = "Female"))
...
Let's try to further visualize the score distributions of the lower 3 performing schools by making box plots comparing them with one another and the district average.

```{r BoxPlotTargets, echo=TRUE}
